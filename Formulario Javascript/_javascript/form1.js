...
var form_init = () => {
    ...
    // resgastando elementos do HTML
    // o botão pelo id="craete_for_bt"
...
var create_form = () => {
    // Busca o id="custom form"  não existendo , ele cria     
...
// entrada de nome
// apresenta uma caixa de input tipo texto
...
// antes de enviar testa se os dados dos formularios foram preenchidos  
...
var verify_form = () => {
    ...
    if( validos()==false)
    {
        ...
        // apelido
        var campo_apelido = document.getElementById("nick");
