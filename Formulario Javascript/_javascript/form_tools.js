...
/* append_span Insere um elemento span com um texto interno. 
Recebe dois parâmetros: o primeiro é o elemento pai onde será inserido o span, 
e o segundo é o texto a ser inserido dentro dele 
*/ 
...
/*
append_text_input
Insere um elemento de texto. 
Recebe quatro parâmetros: 
o elemento pai onde será inserido, um identificador, o tamanho
da caixa de texto e o número máximo de caracteres. 
*/
var append_text_input = (el, id, size, maxlen) => {
      ...
      text_input.classList.add("botton_line");
...
/*
append_select
Insere uma caixa de seleção com múltiplas opções. 
Recebe quatro parâmetros: 
o elemento pai onde será inserido, um identificador, 
um array de opções (cada uma é um objeto com valor e o texto de apresentação) 
e o valor da opção default. 
*/
...
Insere uma caixa de marcação (checkbox). 
Recebe três parâmetros: 
o elemento pai onde será inserido, um identificador e
...
/*
append_submit
Insere um botão de submissão do formulário. 
Recebe três parâmetros: 
o elemento pai onde será inserido, 
o texto do interior do botão e 
uma função de validação para ser invocada quando o formulário for submetido.
*/
var append_submit = (el, text, onsubmit_handler) => {
      ...
      // criando classes no elemento
      submit.classList.add("bt_submit");
